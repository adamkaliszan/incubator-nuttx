/****************************************************************************
 * arch/arm/src/stm32wl5/stm32wl5_dma.c
 *
...
static struct stm32wl5_dma_s g_dma[DMA_NSTREAMS] =
{
  {
    .stream   = 0,
    .irq      = STM32WL5_IRQ_DMA1S0,
    .shift    = DMA_INT_STREAM0_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(0),
  },
  {
    .stream   = 1,
    .irq      = STM32WL5_IRQ_DMA1S1,
    .shift    = DMA_INT_STREAM1_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(1),
  },
  {
    .stream   = 2,
    .irq      = STM32WL5_IRQ_DMA1S2,
    .shift    = DMA_INT_STREAM2_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(2),
  },
  {
    .stream   = 3,
    .irq      = STM32WL5_IRQ_DMA1S3,
    .shift    = DMA_INT_STREAM3_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(3),
  },
  {
    .stream   = 4,
    .irq      = STM32WL5_IRQ_DMA1S4,
    .shift    = DMA_INT_STREAM4_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(4),
  },
  {
    .stream   = 5,
    .irq      = STM32WL5_IRQ_DMA1S5,
    .shift    = DMA_INT_STREAM5_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(5),
  },
  {
    .stream   = 6,
    .irq      = STM32WL5_IRQ_DMA1S6,
    .shift    = DMA_INT_STREAM6_SHIFT,
    .base     = STM32WL5_DMA1_BASE + STM32WL5_DMA_OFFSET(6),
  },
  {
    .stream   = 7,
    .irq      = STM32WL5_IRQ_DMA1S7,
